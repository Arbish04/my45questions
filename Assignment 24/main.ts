interface Book {
  ...
  function runInventoryChecks() {
      ...
      const searchAuthor = "Harper Lee";
      console.log("Author in List Test (True):", books.some(book => book.author === searchAuthor));
      console.log("Author in List Test (False):", books.some(book => book.author === "Mark Twain"));
